...
ストレスなく記録をつけられるように、以下のような状態を目指しました。
...
特に便利になったのは、ジムに着いたときに「今日は何をやるんだっけ」と迷わずに済むこと、
メニューを作成した時に前回の記録が確認できることです。
...
Notion AIを使えば解決できる部分もあるかもしれません。ただ、使い心地が自分にはあまり合わなかったことと、学生にとって月額課金が増えるのはしんどいので別の方法を探して行き着いたのがObsidianでした。
